...
use App\QueryFilters\SupplierServiceInvoiceItemFilters;

class SupplierServiceInvoiceItemService extends BaseService
{
    public function __construct(private SupplierServiceInvoiceItem $model){
    ...
    public function queryGet(array $filters = [] , array $withRelations = []) :builder
    {
        ...
        return (new SupplierServiceInvoiceItemFilters($filters))->apply($supplierAddresses);
    }
