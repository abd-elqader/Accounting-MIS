...
class CountryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(Country $model){
            return view('layouts.dashboard.countries.components.actions',compact('model'))->render();
        })
            ->setRowId('id');
    }
     ...
     */
    public function query(CountryService $service): QueryBuilder
    {
