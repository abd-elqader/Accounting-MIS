...
class TaxDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(Tax $model){
            return view('layouts.dashboard.taxes.components.actions',compact('model'))->render();
        })
            ->setRowId('id');
    }
     ...
     */
    public function query(TaxService $service): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('value_type')->title(__('app.value_type')),
