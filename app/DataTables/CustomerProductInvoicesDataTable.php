...
class CustomerProductInvoicesDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(CustomerProductInvoice $model){
            return view('layouts.dashboard.customer_product_invoices.components.actions',compact('model'))->render();
        })
            ->setRowId('id');
    }
     ...
     */
    public function query(CustomerProductInvoiceService $customerProductInvoiceService): QueryBuilder
    {
        return $customerProductInvoiceService->queryGet(filters: $this->filters);
    }
