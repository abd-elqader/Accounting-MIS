                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-sm mb-4">
                            <div class="col-lg">
                                ...
                                <input class="form-control" name="name" value="{{ old('name') }}"
                                    placeholder="@lang('app.country_name')" type="text">
                                @error('name')
                        ...
                        <div class="row row-sm mb-4">
                            <div class="col-lg">
                                ...
                                <input class="form-control" value="{{ old('code') }}" name="code"
                                    placeholder="@lang('app.code')" type="text">
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" value="{{ old('slug') }}" name="slug"
                                    placeholder="@lang('app.slug')" type="text">
