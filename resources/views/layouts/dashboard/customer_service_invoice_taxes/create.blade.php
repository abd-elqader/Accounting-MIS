...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'first_list_item' => trans('app.customer_service_invoice_tax'),
        'last_list_item' => trans('app.add_customer_service_invoice_tax'),
    ])
    {{--    end breadcrumb --}}
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12"> <!--div-->
            <form action="{{ route('customer_service_invoice_taxes.store') }}" method="post">
                <div class="card">
                    <div class="card-body">
                        @csrf
                        <div class="row row-sm mb-4">
                            ...
                            <div class="col-lg">
                                @livewire('dashboard.customer-service-invoice')
                                @error('CSI_id')
                                    <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            </div>
