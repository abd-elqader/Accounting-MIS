...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'first_list_item' => trans('app.supplier_service_invoice'),
        'last_list_item' => trans('app.add_supplier_service_invoice'),
    ])
    {{--    end breadcrumb --}}
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12"> <!--div-->
            <form id="invoice_form" action="{{ route('supplier_service_invoices.store') }}" method="post">
                <div class="card">
                    <div class="card-body">
        ...
        $('#invoice_submit_button').click(function(e){
            ...
            $.ajax({
                ...
                success:function(responsetext){
                    ...
                    $(".alert_message").text('{{ __("lang.success_operation") }}');
                    $(".alert_message").fadeIn().delay(2000).fadeOut();
                    $(location).attr('href', "{{ route('supplier_service_invoices.index') }}");
                },
                error: function(data_error, exception){
                    $(".load_content").hide();
                    if(exception == "error"){
