...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'last_list_item' => trans('app.add_supplier_product_invoice_item'),
    ])
    {{--    end breadcrumb --}}
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12"> <!--div-->
            <form action="{{ route('supplier_product_invoice_items.store') }}" method="post">
                <div class="card">
                    <div class="card-body">
                        @csrf
                        <div class="row row-sm mb-4">
                            ...
                            <div class="col-lg">
                                @livewire('dashboard.supplier-product-invoice')
                                @error('SPI_id')
                                    <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            </div>
