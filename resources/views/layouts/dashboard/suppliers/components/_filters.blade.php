                                    ...
                                    <div class="row row-sm mb-4">
                                        <div class="col-lg mb-4">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="" selected disabled hidden>@lang('app.select_status')</option>
                                                <option value="">@lang('app.select_all')</option>
                                        ...
                                        <div class="col-lg">
                                            ...
                                            <select class="form-control" name="type">
                                                <option value="" selected disabled hidden>@lang('app.select_type')</option>
                                                <option value="">@lang('app.select_all')</option>
