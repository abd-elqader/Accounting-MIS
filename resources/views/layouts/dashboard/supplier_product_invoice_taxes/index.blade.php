...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'last_list_item' => trans('app.all_supplier_product_invoice_taxes'),
    ])
    {{--    end breadcrumb --}}


    <!--start filters section -->
    @include('layouts.dashboard.supplier_product_invoice_taxes.components.filters')
    <!--end filterd section -->
    <!--Row-->
    <!-- Row -->
                ...
                <div class="card-header">
                    <div class="breadcrumb-header justify-content-between">
                        <div class="left-content">
                            <a class="btn btn-primary" href="{{ route('supplier_product_invoice_taxes.create') }}"><i
