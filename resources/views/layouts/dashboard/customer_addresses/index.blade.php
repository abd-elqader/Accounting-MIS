...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'last_list_item' => trans('app.all_customer_addresses'),
    ])
    {{--    end breadcrumb --}}


    <!--start filters section -->
    @include('layouts.dashboard.customer_addresses.components.filters')
    <!--end filterd section -->
    <!--Row-->
    <!-- Row -->
                ...
                <div class="card-header">
                    <div class="breadcrumb-header justify-content-between">
                        <div class="left-content">
                            <a class="btn btn-primary" href="{{ route('customer_addresses.create') }}"><i
