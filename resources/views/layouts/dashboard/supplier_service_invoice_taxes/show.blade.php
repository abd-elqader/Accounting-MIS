                ...
                <div class="card-body">
                    <div class="row row-sm mb-4">
                        <div class="col-lg">
                            ...
                            <label class="form-control">{{ $supplierServiceInvoiceTax->name }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row row-sm mb-4">
                        <div class="col-lg">
                            ...
                            <label class="form-control">{{ $supplierServiceInvoiceTax->value }}</label>
                        </div>

                        <div class="col-lg">
                            <div class="main-content-label mg-b-5">@lang('app.type')</div>
                            <label class="form-control">{{ $supplierServiceInvoiceTax->type }}</label>
                        </div>
                        
                        <div class="col-lg">
                            <div class="main-content-label mg-b-5">@lang('app.supplier_service_invoice_id')</div>
                            <label class="form-control">{{ $supplierServiceInvoiceTax->SSI_id }}</label>
                        </div>
                    </div>
                </div>
