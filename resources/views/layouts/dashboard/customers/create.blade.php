                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row row-sm mb-4">
                                ...
                                <div class="col-lg">
                                    @livewire('branch', ['branches_for_company_id' => old('company_id') ,'status' => $status])
                                    @error('branch_id')
                                        <div class="text-danger"> {{$message}}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-success">
                            ...
                            <div class="row row-sm mb-4">
                                ...
                                <div class="col-lg">
                                    @livewire("location.subareas", ["subareas_for_area_id" => old('area_id'),'selected_subarea' => old('subarea_id'), 'status' => $status])
                                    @error('subarea_id')
                                    <div class="text-danger"> {{$message}}</div>
                                    @enderror
                                </div>
