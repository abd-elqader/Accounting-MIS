...
{{--    breadcrumb --}}
    @include('layouts.dashboard.components.breadcrumb',['title' => trans('app.customers_page_title'),'first_list_item' => trans('app.customers'),'last_list_item' => trans('app.all_customers')])
{{--    end breadcrumb --}}


    <!--start filters section -->
        @include('layouts.dashboard.customers.components.filters')
    <!--end filterd section -->
    <!--Row-->
    <!-- Row -->
