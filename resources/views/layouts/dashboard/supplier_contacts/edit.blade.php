...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12"> <!--div-->
            <form action="{{ route('supplier_contacts.update', $supplier_contact->id) }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-sm mb-4">
                            <div class="col-lg">
                                ...
                                <input class="form-control" name="type" value="{{ $supplier_contact->type }}"
                            ...
                            <div class="col-lg">
                                @livewire('dashboard.supplier', ['selected_supplier' => $supplier_contact->supplier_id])
                                @error('supplier_id')
                                    <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row row-sm mb-4">
                            <div class="col-lg">
                                ...
                                <input class="form-control" value="{{ $supplier_contact->contact }}" name="contact"
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" value="{{ $supplier_contact->description }}" name="description"
