                ...
                <div class="card-body">
                    <div class="row row-sm mb-4">
                        <div class="col-lg">
                            ...
                            <label class="form-control">{{ $supplierProductInvoice->total_invoice }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row row-sm mb-4">
                        <div class="col-lg">
                            ...
                            <label class="form-control">{{ $supplierProductInvoice->reversed }}</label>
                        </div>

                        <div class="col-lg">
                            <div class="main-content-label mg-b-5">@lang('app.due_date')</div>
                            <label class="form-control">{{ $supplierProductInvoice->due_date }}</label>
                        </div>
                    </div>
                    <div class="row row-sm mb-4">
                        <div class="col-lg">
                            <div class="main-content-label mg-b-5">@lang('app.creation_date')</div>
                            <label class="form-control">{{ $supplierProductInvoice->creation_date }}</label>
                        </div>
                        <div class="col-lg">
                            <div class="main-content-label mg-b-5">@lang('app.creation_date')</div>
                            <label class="form-control">{{ $supplierProductInvoice->supplier_id }}</label>
                        </div>
                    </div>
                </div>
