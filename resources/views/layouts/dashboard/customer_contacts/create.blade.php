...
@section('content')
    ...
    @include('layouts.dashboard.components.breadcrumb', [
        ...
        'last_list_item' => trans('app.add_customer_contact'),
    ])
    {{--    end breadcrumb --}}
                        ...
                        <div class="row row-sm mb-4">
                            <div class="col-lg">
                                ...
                                <select class="form-control" name="type">
                                    <option value="{{\App\Enum\ContactTypeEnum::PHONE}}">@lang('app.phone')</option>
                                    <option value="{{\App\Enum\ContactTypeEnum::EMAIL}}">@lang('app.email')</option>
                                </select>
                                @error('type')
