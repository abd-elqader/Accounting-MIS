							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Customer Service Invoice Taxes</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Customer Service Invoices Taxes</a></li>
										<li><a class="slide-item" href="{{route('customer_service_invoice_taxes.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('customer_service_invoice_taxes.index')}}">View</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Customer Service Invoice Items</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Customer Service Invoices Items</a></li>
										<li><a class="slide-item" href="{{route('customer_service_invoice_items.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('customer_service_invoice_items.index')}}">View</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Supplier Service Invoice Taxes</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Supplier Service Invoices Taxes</a></li>
										<li><a class="slide-item" href="{{route('supplier_service_invoice_taxes.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('supplier_service_invoice_taxes.index')}}">View</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Supplier Service Invoice Items</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Supplier Service Invoices Items</a></li>
										<li><a class="slide-item" href="{{route('supplier_service_invoice_items.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('supplier_service_invoice_items.index')}}">View</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Supplier Product Invoice Taxes</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Supplier Product Invoices Taxes</a></li>
										<li><a class="slide-item" href="{{route('supplier_product_invoice_taxes.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('supplier_product_invoice_taxes.index')}}">View</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										...
										<span class="side-menu__label">Supplier Product Invoice items</span>
										<i class="angle fe fe-chevron-right"></i>
									</a>
									<ul class="slide-menu">
										<li class="side-menu__label1"><a href="javascript:void(0);">Supplier Product Invoices items</a></li>
										<li><a class="slide-item" href="{{route('supplier_product_invoice_items.create')}}">Create</a></li>
										<li><a class="slide-item" href="{{route('supplier_product_invoice_items.index')}}">View</a></li>
